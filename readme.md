...
This is a fork of the official [Yeoman](http://yeoman.io) generator that scaffolds out a front-end web app, with one main difference: it generates **grunt configuration in separate files** and uses [`load-grunt-configs`](http://github.com/creynders/load-grunt-configs) to load them.
